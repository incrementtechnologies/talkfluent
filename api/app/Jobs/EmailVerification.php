...
class EmailVerification implements ShouldQueue
{
    ...
    public function templateHabla(){
        $message = $this->header."
            <br>
            <a href=".$this->host['app'].'account_verification/'.$this->account['username'].'/'.$this->account['code'].">Click here to verify your account.</a>
            </body>
            </html>
        ";
        return $message;
    ...
    public function tempateTalkfluent(){
        $message = $this->header."
            <span class=email-holder>
                ...
                <span class=content>
                    <p>
                        Hello! We just need to verify that ".$this->account['email']." is your email address.
                    </p>
                    <p>Tap the button to confirm:</p>
                    <p>
                        <a class=link href=".$this->host['app'].'account_verification/'.$this->account['username'].'/'.$this->account['code'].">
    ...
    public function send(){
        ...
        $headers = $this->getEmailHeader();
        $subject = 'Email Verification for '.$this->host['app_title'];
        $message = ($this->host['host'] == 'hablainglesfluido.com') ? $this->templateHabla() : $this->tempateTalkfluent();
